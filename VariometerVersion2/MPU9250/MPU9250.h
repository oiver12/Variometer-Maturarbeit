...
public:
    ...
    bool getINTStatus()
    {
        return (read_byte(mpu_i2c_addr, INT_STATUS) & 0x01);
    }

    bool available() {
        byte readByte = read_byte(mpu_i2c_addr, INT_STATUS);
        //Serial.println(String(readByte & 0x01) + " , " + String(has_connected));
        return has_connected && (readByte & 0x01);
        //return has_connected;
    }
